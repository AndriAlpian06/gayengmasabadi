...
const Contact = () => {
  ...
  return (
    <>
        <div className="isolate px-6 py-24 sm:py-32 lg:px-8" data-aos="flip-left" data-aos-duration="3000">
            ...
            <div className="mx-auto max-w-2xl text-center">
                ...
                <p className="mt-2 text-lg leading-8 text-gray-600">Send A Message</p>
            </div>
            <form action="#" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20">
                <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                <div className="sm:col-span-2">
                    <label htmlFor="company" className="block text-sm font-semibold leading-6 text-gray-900">Name</label>
                ...
                <div className="mt-10">
                <button type="submit" className="block w-full rounded-md bg-orange-700 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Submit</button>
                </div>
            </form>
        </div>
    </>
