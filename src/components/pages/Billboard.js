...
const Branding = () => {
    ...
    const data = [
    { id: 1, category: 'Medan', name: 'Medan 1', img:'https://gayengmasabadi.com/wp-content/uploads/2023/03/Medan-6.jpg' },
    { id: 2, category: 'Jawa_Tengah', name: 'Jawa Tengah 1', img:'https://gayengmasabadi.com/wp-content/uploads/2023/03/Jawa-Tengah-6-scaled.jpg' },
    { id: 3, category: 'Medan', name: 'Medan 1', img:'https://gayengmasabadi.com/wp-content/uploads/2023/03/Medan-1.jpg' },
    { id: 4, category: 'Jawa_Tengah', name: 'Jawa Tengah 2', img:'https://gayengmasabadi.com/wp-content/uploads/2023/03/Jawa-Tengah-7-scaled.jpg' },
    ];
  ...
  return (
    <>
        {/* Billboard  */}
        <div className='px-4'>
            <h1 className='mt-32 text-6xl font-bold text-left px-4 text-orange-700 uppercase'>Billboard</h1>
        </div>
        <div className='px-4 mb-16'>
            <div className="flex items-center justify-start py-4 md:py-8 flex-wrap px-4 mt-4">
                ...
                <button
                    ...
                    onClick={() => setSelectedCategory('Jawa_Tengah')}
                >
                    JAWA TENGAH
                </button>
                <button
                    ...
                    onClick={() => setSelectedCategory('Medan')}
                >
                    MEDAN
                </button>
            </div>
